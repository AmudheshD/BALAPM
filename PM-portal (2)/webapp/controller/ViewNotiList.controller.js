...
sap.ui.define([
			...
			return Controller.extend("test.routing-sample.controller.ViewNotiList", {
				...
				onInit: function() {
					...
					var uri = "?$filter=ImPlanningPlant eq '0001' and ImPlannerGroup eq '010' and ImNotificationDate eq datetime'2022-02-02T00:00:00'&$format=json";
					window.console.log(uri);
					oModel.read("/zod_mp_notification1Set" + uri,{
						context: null,
						urlParameter: null,
						async: false,
